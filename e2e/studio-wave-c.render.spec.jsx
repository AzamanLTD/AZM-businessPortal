// e2e/studio-wave-c.render.spec.jsx
// =============================================================================
// Wave C rendered acceptance — REAL browser evidence (headless Chromium via
// the Vite dev server). This suite proves the physical scroll/clipping/relayout
// geometry of the current production Studio V2, which JSDOM cannot measure
// (no layout engine). Source-string and inline-style assertions remain in the
// Vitest suites; here every criterion is established by real rendered
// geometry, real hit-testing and real wheel interactions:
//
//   A — device-frame scroll: the rendered stage content genuinely overflows
//       the frame and the frame is the scrollable geometry boundary.
//   B — vertical scrolling: initial position top, wheel scrolls the frame,
//       content physically moves, the outer Studio regions do not own it.
...
//   D — overscroll containment: with the outer Studio main region genuinely
//       scrollable (desktop stage), wheeling at the frame's scroll bottom
//       neither scrolls the frame nor chains into the outer region.
//   E — responsive relayout: the real viewport buttons drive
//       emulator/frame geometry and the rendered product-grid column count;
//       the persisted document object stays byte-identical.
